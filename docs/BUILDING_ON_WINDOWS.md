# Building Crystal on Windows

This document explains how to build Crystal for Windows.
...
- `Crystal-{version}-Windows-x64.exe` - x64 installer
- `Crystal-{version}-Windows-arm64.exe` - ARM64 installer
- `Crystal-{version}-Windows.exe` - Multi-arch installer (both x64 and ARM64)
