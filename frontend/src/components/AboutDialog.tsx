      ...
      <div className="bg-surface-primary rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[80vh] overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            {versionInfo?.appDirectory && (
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-text-secondary">
                  foozol Directory
                </span>
                <span className="text-sm text-text-primary font-mono truncate max-w-[200px]" title={versionInfo.appDirectory}>
                  {versionInfo.appDirectory.replace(/^\/Users\/[^/]+/, '~')}
                </span>
              </div>
            )}
          ...
          <div className="space-y-2">
            <a
              href="https://github.com/nicepkg/foozol"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="pt-4 border-t border-border-primary">
            <p className="text-xs text-text-tertiary leading-relaxed">
              foozol is an independent project created by Dcouple Inc. Claude™ is a trademark of Anthropic, PBC.
